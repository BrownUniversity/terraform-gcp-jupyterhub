...
| <a name="input_description"></a> [description](#input\_description) | VPC description | `string` | `"Deployed through Terraform."` | no |
...
| <a name="input_dns_manager"></a> [dns\_manager](#input\_dns\_manager) | Service used to manage your DNS | `string` | `"infoblox"` | no |
